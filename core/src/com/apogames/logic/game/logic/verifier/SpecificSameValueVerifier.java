...
public class SpecificSameValueVerifier extends Verifier {
    ...
    public java.util.List<Verifier> getAllConfigurations(Solution sol) {
        ...
        list.add(new SpecificSameValueVerifier(sol, true, false, false, this.value));
        list.add(new SpecificSameValueVerifier(sol, false, true, false, this.value));
        list.add(new SpecificSameValueVerifier(sol, false, false, true, this.value));
        return list;
    }
