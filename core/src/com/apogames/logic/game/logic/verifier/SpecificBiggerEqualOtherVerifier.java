...
public class SpecificBiggerEqualOtherVerifier extends Verifier {

    public SpecificBiggerEqualOtherVerifier(Solution solution, boolean isFirst, boolean isSecond, boolean isThird) {
        super(solution, isFirst, isSecond, isThird);
        this.setColumn(3);
    }

    public Verifier getCopy() {
        Verifier verifier = new SpecificBiggerEqualOtherVerifier(super.getSolution(), isFirst(), isSecond(), isThird());
        verifier.setCheck(this.getCheck());
        return verifier;
    }

    public Verifier getCopyWithSolution(Solution newSolution) {
        Verifier verifier = new SpecificBiggerEqualOtherVerifier(newSolution, isFirst(), isSecond(), isThird());
        verifier.setCheck(this.getCheck());
        return verifier;
    }
    ...
    public boolean check(int first, int second, int third, ArrayList<Solution> possibleSolutions, int index) {
        ...
        boolean firstBiggest = first >= second && first >= third;
        boolean secondBiggest = second >= first && second >= third;

        if (check) {
            if (firstBiggest) {
                this.setCheck("first " + loc.getCommon().get("common_isbiggest") + " " + loc.getCommon().get("common_or") + " second " + loc.getCommon().get("common_or") + " third " + loc.getCommon().get("common_arenotsmallest"));
            } else if (secondBiggest) {
                this.setCheck("second " + loc.getCommon().get("common_isbiggest") + " " + loc.getCommon().get("common_or") + " first " + loc.getCommon().get("common_or") + " third " + loc.getCommon().get("common_arenotsmallest"));
            } else {
                this.setCheck("third " + loc.getCommon().get("common_isbiggest") + " " + loc.getCommon().get("common_or") + " first " + loc.getCommon().get("common_or") + " second " + loc.getCommon().get("common_arenotsmallest"));
            }
        } else {
            if (firstBiggest) {
                this.setCheck("first " + loc.getCommon().get("common_isnotbiggest") + " " + loc.getCommon().get("common_or") + " second " + loc.getCommon().get("common_or") + " third " + loc.getCommon().get("common_aresmallest"));
            } else if (secondBiggest) {
                this.setCheck("second " + loc.getCommon().get("common_isnotbiggest") + " " + loc.getCommon().get("common_or") + " first " + loc.getCommon().get("common_or") + " third " + loc.getCommon().get("common_aresmallest"));
            } else {
                this.setCheck("third " + loc.getCommon().get("common_isnotbiggest") + " " + loc.getCommon().get("common_or") + " first " + loc.getCommon().get("common_or") + " second " + loc.getCommon().get("common_aresmallest"));
            }
        }
    ...
    public String getName() {
        return "Ist eine Zahl größer oder gleich in vergleich zu den anderen";
    }

    @Override
    public int getId() {
        return VerifyIDEnum.SpecificBiggerEqualOtherVerifier.getValue();
    }
    ...
    public void renderTextBig(MainPanel mainPanel, int changeX, int changeY) {
        String title = com.apogames.logic.common.Localization.getInstance().getCommon().get("verifier_specificbiggerequalother_title");
    ...
    public void renderText(MainPanel mainPanel, int changeX, int changeY) {
        ...
        String col1Text = loc.getCommon().get("verifier_specificbiggerequalother_col1_text");
        ...
        String col2Text = loc.getCommon().get("verifier_specificbiggerequalother_col2_text");
        ...
        String col3Text = loc.getCommon().get("verifier_specificbiggerequalother_col3_text");
